        ...
        <div className='flex items-center justify-center flex-col h-screen'>
            <div className={`${styles.auth} flex flex-col gap-8`} >
                <header className='flex flex-col justify-center gap-2'>
                    <h1 className='text-center text-xl font-semibold'>Создайте свой аккаунт</h1>
                    <p className={`${styles.header_p} text-center text-base font-normal`}>Добро пожаловать! Пожалуйста, заполните данные, чтобы начать.</p>
                </header>
